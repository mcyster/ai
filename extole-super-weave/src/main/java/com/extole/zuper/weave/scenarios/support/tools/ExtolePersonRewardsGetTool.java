...
import com.extole.zuper.weave.scenarios.support.tools.ExtolePersonRewardsGetTool.Request;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonPropertyDescription;
import com.fasterxml.jackson.databind.JsonNode;

@Component
class ExtolePersonRewardsGetTool implements ExtoleSupportTool<Request> {
    ...
    ExtolePersonRewardsGetTool(ExtoleTrustedWebClientFactory extoleWebClientFactory) {
    ...
    public Object execute(Request request, ExtoleSuperContext context, OperationLogger operation) throws ToolException {
        ...
        try {
            result = this.extoleWebClientFactory.getWebClientById(request.client_id).get()
                    .uri(uriBuilder -> uriBuilder.path("/v4/runtime-persons/" + request.person_id + "/rewards").build())
