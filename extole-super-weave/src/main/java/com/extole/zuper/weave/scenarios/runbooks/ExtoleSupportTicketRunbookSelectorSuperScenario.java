...
@Component
public class ExtoleSupportTicketRunbookSelectorSuperScenario implements Scenario<Parameters, ExtoleSuperContext> {
    ...
    public ExtoleSupportTicketRunbookSelectorSuperScenario(AiService aiService, AiAdvisorService aiAdvisorService,
